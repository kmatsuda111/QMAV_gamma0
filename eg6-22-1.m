...
F is: Quadratic Field with defining polynomial $.1^2 - 2 over the Rational Field
k is: Number Field with defining polynomial x^4 + 30*x^2 + 361 over the Rational
Field
Is k/Q normal? true
h_k = 8
n_lcm = 24
The set of primes <= 40 satisfying the condition 1 of thm. 6.20 is: { 7, 23, 31
}
